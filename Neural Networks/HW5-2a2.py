...
class NeuralNetwork:
    def __init__(self,n1,n2):
        self.n1 = n1
        self.n2 = n2
        self.weight_1 = np.array([[-1,-1],[-2,2],[-3,3]])
        self.weight_2 = np.array([[-1,1],[-2,2],[-3,3]])
        self.weight_3 = np.array([[-1],[2],[-1.5]])
...
print("Runnning problem 2(b)")
nn = NeuralNetwork(2,2)
x = np.array([1,1,1])
y = 1
output = nn.forward(x,y)
param_3, param_2, param_1 = nn.backward(output, x,y)
print("*"*50)
